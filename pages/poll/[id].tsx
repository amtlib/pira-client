...
export default function PollPage() {
    ...
    const { data, loading, error } = useQuery(POLL, { variables: { id, userId } });
        ...
        <>
            ...
            <div className={classes.paper}>
                <Paper elevation={2} className={classes.paper}>
                    ...
                    <Survey answers={data?.poll?.answers} type="radio" hasUserAnswered={data?.poll?.hasUserAnswered} isOpen={data?.poll?.level !== "closed"} />
                </Paper>
            </div>
            ...
            <div className={classes.row}>
                ...
                <Donut pollId={id as string} age={{ min: 61, max: 90 }} />
            </div>
            <div className={classes.row}>
                <Typography component="h2" variant="h5">
                    Tagi
